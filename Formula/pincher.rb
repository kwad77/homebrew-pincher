...
#
# Pinned to v0.21.0. The SHA256 values below are from the authoritative
# SHA256SUMS file published with that release:
# https://github.com/kwad77/pincher/releases/download/v0.21.0/SHA256SUMS
#
# Usage:
...
class Pincher < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "aaed0f889729d21383a8315d932f1f9964b33df492b90d831dfb1d6c52bff0b1"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-darwin-amd64.tar.gz"
      sha256 "06bb5a4f91c518b2e499c9357e4cbe47383b18d4a0298e0797729dbddf0c73e8"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "65ba1f39dcccd568b1405f4b6448a0d8e1cb34ffbc1f12f7ed6ec101ec53cf20"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-linux-amd64.tar.gz"
      sha256 "428958f02446e7a241e48b64761a550c1b4ac03a6fbafe990f0d4bfe4b4c5c76"
    end
  end
